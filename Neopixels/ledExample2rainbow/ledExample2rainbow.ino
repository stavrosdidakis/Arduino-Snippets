...
uint32_t Wheel(uint16_t WheelPos)
{
  ...
  {
    case 0:
      r = (val-1) - WheelPos % val; // red down
      g = WheelPos % val;       // green up
      b = 0;                    // blue off
      break;
    case 1:
      g = (val-1) - WheelPos % val; // green down
      b = WheelPos % val;       // blue up
      r = 0;                    // red off
      break;
    case 2:
      b = (val-1) - WheelPos % val; // blue down
      r = WheelPos % val;       // red up
      g = 0;                    // green off
      break;
  }
